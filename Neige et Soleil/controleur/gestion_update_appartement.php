...
if(isset($_GET['action']) && isset($_GET['ref_hab'])){
        ...
        if($action == "modif"){
                $habitation = $unControleur->selectWhereAppartement($refHab);
...
if (isset($_POST['ajouter'])){
        ...
        $champs = [$tarif_hab_bas, $tarif_hab_moyen, $tarif_hab_haut,
                   $description_hab, $titre_hab, $capacite_hab,$etage_ap,
                   $type_ap
                  ];
        ...
        if (!empty($erreurs)) { 
                ...
                header("Location:index.php?page=27&action=modif&ref_hab=".$refHab); 
                exit; 
        }else{
                //update habitations
                $unControleur->updateAppartementAnnonce([
...
if(isset($_POST['annuler'])){
        ...
        require_once("vue/vue_update_appartement.php");
