...
create table proprietaires(
    ...
    nom_rue_p varchar(50) not null,
    num_rue_p int(4) not null,
    cp_p int(5) not null,
    ville_p varchar(50) not null,
    tel_p int(10) not null,
    rib_p int(25) not null,
    primary key (id_p)
);
...
create table habitation(
    ...
    nom_rue_hab varchar(50) not null,
    num_rue_hab int(4) not null,
